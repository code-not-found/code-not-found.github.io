...
Based on following great example on [writing functional tests using Selenium](https://www.pluralsight.com/guides/getting-started-with-page-object-pattern-for-your-selenium-tests){:target="_blank"} we have made above test case extend a `WebDriverUtil` class.
...
Or just to let me know how you are testing your JSF application.
