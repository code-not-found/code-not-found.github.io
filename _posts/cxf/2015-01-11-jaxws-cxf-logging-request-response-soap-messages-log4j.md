...
<project xmlns="http://maven.apache.org/POM/4.0.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    ...
    <url>https://codenotfound.com/2015/01/jaxws-cxf-logging-request-response-soap-messages-log4j.html</url>
...
If you would like to run the above code sample you can get the full source code [here](https://github.com/code-not-found/jaxws-cxf/tree/master/jaxws-jetty-cxf-logging-log4j).
{% endcapture %}
