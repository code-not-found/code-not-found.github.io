...
> Make sure all right angle brackets within the <pre> tags are HTML escaped, in other words all < (less than character) must be replaced with "<pre>&lt;</pre>" (without quotes, as shown below)!
