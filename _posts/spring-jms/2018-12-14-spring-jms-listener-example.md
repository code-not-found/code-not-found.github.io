...
There is even an [easier way](https://docs.spring.io/spring/docs/5.1.3.RELEASE/spring-framework-reference/integration.html#jms-annotated){:target="_blank"} to create a Spring JMS listener.
